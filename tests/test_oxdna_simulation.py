...
class TestSimulation:
    ...
    def test_build_no_existing_dir(self, sim):
        ...
        assert top_file.exists(), "Top file was not copied correctly"
        assert dat_file.exists(), "Dat file was not copied correctly"

        # Check for the creation of input files
        input_dir = sim.sim_dir / 'input'
        input_json = sim.sim_dir / 'input.json'

        print(f"Input directory exists: {input_dir.exists()}")
        print(f"Input.json file exists: {input_json.exists()}")

        assert input_dir.exists(), "Input file was not created"
        assert input_json.exists(), "Input.json file was not created"
